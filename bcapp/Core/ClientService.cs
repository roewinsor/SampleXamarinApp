...
namespace bcapp.Core
{
    public class ClientService
    {
        public static async Task<UserInfo> GetUserInfo(string method, UserInfo user)
        {
            string queryString = "http://192.168.254.104:56251/api/userinfo";
